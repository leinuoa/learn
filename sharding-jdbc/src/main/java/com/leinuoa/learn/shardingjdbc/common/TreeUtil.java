...
public class TreeUtil<T extends TreeVo> {
    ...
    public static void main(String[] args) {
        TreeVo tree1 = new TreeVo("c1","0","四川省");
        TreeVo tree2 = new TreeVo("g2","c1","成都市");
        TreeVo tree3 = new TreeVo("w3","c1","巴中市");
        TreeVo tree4 = new TreeVo("t4","c1","绵阳市");
        TreeVo tree5 = new TreeVo("a5","c1","德阳市");
        TreeVo tree6 = new TreeVo("s6","g2","锦江区");
        TreeVo tree7 = new TreeVo("t7","g2","成华区");
        TreeVo tree8 = new TreeVo("8o","g2","高新区");
        TreeVo tree9 = new TreeVo("j9","g2","新津区");
        TreeVo tree10 = new TreeVo("10","0","陕西省");
        TreeVo tree11 = new TreeVo("11","10","西安市");
        TreeVo tree12 = new TreeVo("12","10","咸阳市");
        TreeVo tree13 = new TreeVo("13","11","雁塔区");
        TreeVo tree14 = new TreeVo("14","11","高新区");

        List<TreeVo> list = new ArrayList<>();
        list.addAll(Arrays.asList(tree1,tree2,tree3,tree4,tree5,tree6,tree7,tree8,tree9,tree10,tree11,tree12,tree13,tree14));
